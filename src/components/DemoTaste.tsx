...
export default function DemoTaste() {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-2 h-2 bg-primary rounded-full animate-glow-pulse" />
      <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-primary rounded-full animate-glow-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 mx-auto mb-8 bg-primary/20 rounded-full flex items-center justify-center"
          >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-10 py-5 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
          >
