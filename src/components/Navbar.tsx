      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#home" className="flex items-center gap-3">
            <img src={logo} alt="BABA Caterers" className="h-12 w-auto" />
            <span className="font-display text-xl text-primary hidden sm:block">BABA Caterers</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="tel:9565655574"
              className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-full font-medium text-sm hover:bg-primary/90 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
